...
@Repository
public class TizenBomLicenseDaoImpl implements TizenBomLicenseDao
{
	@Autowired
	...
	public List<TizenBom> getList(String platformVersion)
	{
		Map<String, Object> condition = new HashMap<String, Object>();
		condition.put("platformVersion", platformVersion);
		return session.selectList(String.format("%s.selectTizenBomListbyLicense", MAPPER_NS), condition);
	}
